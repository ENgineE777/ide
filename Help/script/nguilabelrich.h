...
class NGUILabelRich
{
  public:
   ...
   NGUILabelRich@ opCast();
   void SetFontColor(float r, float g, float b);
   void GetFontColor(float&out r, float&out g, float&out b);
   ...
   int  CheckLinks(string&out text);
   int  CheckLinksId();
   void SetFilled(bool flag);
   bool IsFilled();
   void SetFilledColor(float r, float g, float b,float a);
   void SetFilledColor(string&in txt);
   void GetFilledColor(float&out r, float&out g, float&out b, float&out a);
   void SetLinksColor(float r, float g, float b);
   void GetLinksColor(float&out r, float&out g, float&out b);
   void SetFindLinks(bool flag);
   bool IsFindLinksEnable();
};
